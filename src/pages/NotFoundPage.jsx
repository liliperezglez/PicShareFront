  ...
  return (
    <section className='not-found-container'>
      <div className='not-found-content'>
        ...
        <p className='not-found-message'>La página que buscas está más escondida que Wally en una foto.</p>
        <p className='not-found-message'>Pero podemos llevarte de vuelta a la diversión.</p>
