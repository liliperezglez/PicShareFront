        ...
        <div className='config-content'>
          ...
          {token && (
            <button onClick={openEditProfile}>
              <svg xmlns='http://www.w3.org/2000/svg' width='25' height='25' fill='currentColor' className='bi bi-person-fill-gear' viewBox='0 0 16 16'>
          ...
          {!token && (
            <button className='auth-register'>
              <Link to='/login'>
                <svg xmlns='http://www.w3.org/2000/svg' width='27' height='25' fill='currentColor' className='bi bi-box-arrow-in-right' viewBox='0 0 16 16'>
                  <path
                    fillRule='evenodd'
